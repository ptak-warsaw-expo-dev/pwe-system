# `PWE_System_Replace_Content_Admin_Page::get_summary()`

**Źródło:** `modules/replace-content/core/admin-page.php:154`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static get_summary(array $plan)`
