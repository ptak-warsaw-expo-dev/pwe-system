# `PWE_System_Replace_Content_Admin_Page::render_translation()`

**Źródło:** `modules/replace-content/core/admin-page.php:226`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static render_translation(array $translation, array $active_languages)`

## Kontekst

- Symbol właściciela: [`PWE_System_Replace_Content_Admin_Page`](../../classes/PWE_System_Replace_Content_Admin_Page.md)
- Plik: [dokument pliku](../../../files/modules/replace-content/core/admin-page.php.md)
