# `PWE_System_Replace_Content_Admin_Page::render_plan_item()`

**Źródło:** `modules/replace-content/core/admin-page.php:184`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static render_plan_item(array $item, array $active_languages)`
