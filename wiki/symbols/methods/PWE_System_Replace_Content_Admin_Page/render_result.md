# `PWE_System_Replace_Content_Admin_Page::render_result()`

**Źródło:** `modules/replace-content/core/admin-page.php:105`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static render_result(?array $result)`
