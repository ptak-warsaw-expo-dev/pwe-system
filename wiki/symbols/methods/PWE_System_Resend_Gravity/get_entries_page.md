...
**Źródło:** `modules/resend/core/gravity-entries.php:32`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_entries_page(int $form_id, bool $include_all_entries, int $offset, int $page_size, int $min_age_days = PWE_System_Resend::DEFAULT_MIN_AGE_DAYS)`
