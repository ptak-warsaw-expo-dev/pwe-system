# `PWE_System_Resend_Gravity::entries_error_message()`

**Źródło:** `modules/resend/core/gravity-entries.php:161`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static entries_error_message(int $form_id, string $details)`
