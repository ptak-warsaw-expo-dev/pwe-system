# `PWE_System_Forms_Audit_Tool::__construct()`

**Źródło:** `modules/forms-audit/pwe-forms-audit-module.php:42`  
**Typ właściciela:** `class`  
**Sygnatura:** `public __construct($qr)`

## Kontekst

- Symbol właściciela: [`PWE_System_Forms_Audit_Tool`](../../classes/PWE_System_Forms_Audit_Tool.md)
- Plik: [dokument pliku](../../../files/modules/forms-audit/pwe-forms-audit-module.php.md)
