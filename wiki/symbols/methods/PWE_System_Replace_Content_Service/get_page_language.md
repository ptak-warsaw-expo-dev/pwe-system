# `PWE_System_Replace_Content_Service::get_page_language()`

**Źródło:** `modules/replace-content/core/replace-content-service.php:401`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static get_page_language(int $post_id, string $element_type)`
