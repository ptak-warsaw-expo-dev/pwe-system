# `PWE_System_Replace_Content_Service::get_wpml_translations()`

**Źródło:** `modules/replace-content/core/replace-content-service.php:307`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static get_wpml_translations(WP_Post $source_page, string $shortcode)`
