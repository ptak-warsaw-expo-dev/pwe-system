# `PWE_System_Replace_Content_Service::add_translation()`

**Źródło:** `modules/replace-content/core/replace-content-service.php:363`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static add_translation(array &$translations, int $post_id, string $language, string $shortcode, bool $is_original = false)`
