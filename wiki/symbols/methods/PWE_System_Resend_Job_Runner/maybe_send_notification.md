# `PWE_System_Resend_Job_Runner::maybe_send_notification()`

**Źródło:** `modules/resend/core/job-runner.php:226`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static maybe_send_notification(array $form, array $entry, array $notification)`
