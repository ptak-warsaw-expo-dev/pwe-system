# `PWE_Shortcodes::display_trade_fair_contact_media_person_phone_3()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2208`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_phone_3()`
