# `PWE_Shortcodes::display_trade_fair_contact_service_phone()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2164`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_service_phone()`
