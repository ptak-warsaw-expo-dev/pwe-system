# `PWE_Shortcodes::display_trade_fair_contact_media_phone()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2172`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_phone()`
