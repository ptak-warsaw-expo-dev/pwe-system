# `PWE_Shortcodes::display_trade_fair_contact_service_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2168`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_service_email()`
