# `PWE_Shortcodes::display_trade_fair_contact_media_name()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2176`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_name()`
