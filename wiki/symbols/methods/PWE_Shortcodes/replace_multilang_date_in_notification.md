# `PWE_Shortcodes::replace_multilang_date_in_notification()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3649`  
**Typ właściciela:** `class`  
**Sygnatura:** `public replace_multilang_date_in_notification($notification, $form, $entry)`

## Kontekst

- Symbol właściciela: [`PWE_Shortcodes`](../../classes/PWE_Shortcodes.md)
- Plik: [dokument pliku](../../../files/modules/shortcodes/class-shortcodes.php.md)
