# `PWE_Shortcodes::show_trade_fair_registration_benefits_en()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3097`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_registration_benefits_en()`
