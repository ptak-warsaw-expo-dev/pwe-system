# `PWE_Shortcodes::show_trade_fair_ticket_benefits_en()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3128`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_ticket_benefits_en()`
