# `PWE_Shortcodes::display_trade_fair_conference_title()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:1710`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_conference_title()`
