# `PWE_Shortcodes::display_trade_fair_registration_benefits_en()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2279`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_registration_benefits_en()`
