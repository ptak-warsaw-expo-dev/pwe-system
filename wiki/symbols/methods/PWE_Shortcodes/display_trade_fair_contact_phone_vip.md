# `PWE_Shortcodes::display_trade_fair_contact_phone_vip()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2232`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_phone_vip()`
