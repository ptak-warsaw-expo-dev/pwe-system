# `PWE_Shortcodes::display_trade_fair_contact_medal_ceremony_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2236`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_medal_ceremony_email()`
