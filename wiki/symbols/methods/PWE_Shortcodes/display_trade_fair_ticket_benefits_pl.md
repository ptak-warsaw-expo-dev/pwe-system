# `PWE_Shortcodes::display_trade_fair_ticket_benefits_pl()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2297`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_ticket_benefits_pl()`
