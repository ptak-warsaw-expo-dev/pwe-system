# `PWE_Shortcodes::show_trade_fair_contact_medal_ceremony_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3067`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_medal_ceremony_email()`
