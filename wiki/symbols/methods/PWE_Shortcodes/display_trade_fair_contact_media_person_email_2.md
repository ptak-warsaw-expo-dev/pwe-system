# `PWE_Shortcodes::display_trade_fair_contact_media_person_email_2()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2200`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_email_2()`
