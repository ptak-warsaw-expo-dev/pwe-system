# `PWE_Shortcodes::show_trade_fair_contact_media_phone()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3027`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_media_phone()`
