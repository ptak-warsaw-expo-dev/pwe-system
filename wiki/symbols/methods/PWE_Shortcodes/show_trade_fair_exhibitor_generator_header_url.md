# `PWE_Shortcodes::show_trade_fair_exhibitor_generator_header_url()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3394`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_exhibitor_generator_header_url()`
