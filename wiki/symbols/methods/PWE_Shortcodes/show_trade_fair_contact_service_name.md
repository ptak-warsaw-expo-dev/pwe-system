# `PWE_Shortcodes::show_trade_fair_contact_service_name()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3015`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_service_name()`
