# `PWE_Shortcodes::show_trade_fair_edition()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2809`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_edition($entry = null, $fields = null)`
