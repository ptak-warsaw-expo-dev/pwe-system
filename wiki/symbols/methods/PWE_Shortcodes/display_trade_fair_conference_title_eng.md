# `PWE_Shortcodes::display_trade_fair_conference_title_eng()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:1727`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_conference_title_eng()`
