# `PWE_Shortcodes::display_trade_fair_registration_benefits_pl()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2261`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_registration_benefits_pl()`
