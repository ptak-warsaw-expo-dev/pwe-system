# `PWE_Shortcodes::show_trade_fair_date_custom_format()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2462`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_date_custom_format()`
