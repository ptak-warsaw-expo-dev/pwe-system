# `PWE_Shortcodes::display_trade_fair_contact_email_vip()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2228`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_email_vip()`
