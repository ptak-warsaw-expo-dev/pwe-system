# `PWE_Shortcodes::display_trade_fair_contact_media_person_phone()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2184`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_phone()`
