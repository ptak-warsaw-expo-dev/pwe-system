# `PWE_Shortcodes::show_trade_fair_contact_media_person_name()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3035`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_media_person_name()`
