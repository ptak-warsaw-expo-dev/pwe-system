# `PWE_Shortcodes::display_trade_fair_contact_media_person_name_2()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2192`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_name_2()`
