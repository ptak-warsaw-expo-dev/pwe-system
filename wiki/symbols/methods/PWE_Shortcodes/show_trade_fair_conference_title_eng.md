# `PWE_Shortcodes::show_trade_fair_conference_title_eng()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2745`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_conference_title_eng()`
