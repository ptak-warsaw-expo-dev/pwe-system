# `PWE_Shortcodes::display_trade_fair_contact_media_person_name_3()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2204`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_name_3()`
