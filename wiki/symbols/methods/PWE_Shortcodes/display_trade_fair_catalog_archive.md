# `PWE_Shortcodes::display_trade_fair_catalog_archive()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:1641`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_catalog_archive()`
