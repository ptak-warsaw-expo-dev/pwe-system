# `PWE_Shortcodes::display_trade_fair_contact_media_person_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2188`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_email()`
