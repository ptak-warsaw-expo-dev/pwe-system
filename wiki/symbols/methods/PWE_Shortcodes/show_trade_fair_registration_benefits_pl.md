# `PWE_Shortcodes::show_trade_fair_registration_benefits_pl()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3083`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_registration_benefits_pl()`
