# `PWE_Shortcodes::show_trade_fair_contact_media_person_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3043`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_media_person_email()`
