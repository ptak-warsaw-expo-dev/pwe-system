# `PWE_Shortcodes::display_trade_fair_ticket_benefits_en()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2318`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_ticket_benefits_en()`
