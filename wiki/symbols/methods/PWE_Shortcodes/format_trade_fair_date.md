# `PWE_Shortcodes::format_trade_fair_date()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:1030`  
**Typ właściciela:** `class`  
**Sygnatura:** `public format_trade_fair_date($start_date, $end_date, $lang = "pl")`
