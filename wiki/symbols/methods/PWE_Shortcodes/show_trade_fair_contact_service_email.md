# `PWE_Shortcodes::show_trade_fair_contact_service_email()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3023`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_service_email()`
