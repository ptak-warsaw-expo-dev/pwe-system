# `PWE_Shortcodes::show_trade_fair_contact_service_phone()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:3019`  
**Typ właściciela:** `class`  
**Sygnatura:** `public show_trade_fair_contact_service_phone()`
