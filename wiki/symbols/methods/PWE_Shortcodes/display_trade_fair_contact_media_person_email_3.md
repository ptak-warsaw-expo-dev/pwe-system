# `PWE_Shortcodes::display_trade_fair_contact_media_person_email_3()`

**Źródło:** `modules/shortcodes/class-shortcodes.php:2212`  
**Typ właściciela:** `class`  
**Sygnatura:** `public display_trade_fair_contact_media_person_email_3()`
