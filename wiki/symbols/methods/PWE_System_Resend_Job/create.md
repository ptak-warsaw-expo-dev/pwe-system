...
**Źródło:** `modules/resend/core/resend-job.php:64`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static create(array $form_ids, int $batch_size, int $delay, bool $include_all_entries, int $min_age_days)`
