# `PWE_System_Resend_Job::count_remaining()`

**Źródło:** `modules/resend/core/resend-job.php:341`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static count_remaining(array $job, string $lock_token)`
