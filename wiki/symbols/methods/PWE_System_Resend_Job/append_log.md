...
**Źródło:** `modules/resend/core/resend-job.php:221`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static append_log(array &$job, int $entry_id, string $notification, string $status, string $message)`
