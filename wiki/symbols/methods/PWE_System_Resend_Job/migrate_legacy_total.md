# `PWE_System_Resend_Job::migrate_legacy_total()`

**Źródło:** `modules/resend/core/resend-job.php:262`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static migrate_legacy_total(array $fallback_job)`
