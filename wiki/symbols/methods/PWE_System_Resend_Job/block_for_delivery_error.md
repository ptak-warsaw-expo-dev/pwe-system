...
**Źródło:** `modules/resend/core/resend-job.php:177`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static block_for_delivery_error(array &$job, int $entry_id, string $notification, string $message)`
