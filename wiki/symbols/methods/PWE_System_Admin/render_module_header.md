...
**Źródło:** `core/class-pwe-system-admin.php:102`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static render_module_header(string $kicker, string $title, string $description, string $icon = '')`

## Kontekst

- Symbol właściciela: [`PWE_System_Admin`](../../classes/PWE_System_Admin.md)
- Plik: [dokument pliku](../../../files/core/class-pwe-system-admin.php.md)
