# `PWE_System_Forms_Audit_Notifications_Trait::email_list_contains()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:2135`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private email_list_contains($emails, $target_email)`
