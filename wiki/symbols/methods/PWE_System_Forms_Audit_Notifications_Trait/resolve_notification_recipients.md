# `PWE_System_Forms_Audit_Notifications_Trait::resolve_notification_recipients()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:2034`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private resolve_notification_recipients($notification, $form, $entry)`
