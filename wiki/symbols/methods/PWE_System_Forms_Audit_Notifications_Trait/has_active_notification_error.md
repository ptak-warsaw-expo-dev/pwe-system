# `PWE_System_Forms_Audit_Notifications_Trait::has_active_notification_error()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1307`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private has_active_notification_error($form, $entry_id)`
