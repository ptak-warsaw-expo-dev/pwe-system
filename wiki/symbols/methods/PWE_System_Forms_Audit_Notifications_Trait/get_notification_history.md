# `PWE_System_Forms_Audit_Notifications_Trait::get_notification_history()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:842`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_notification_history($entry_id)`
