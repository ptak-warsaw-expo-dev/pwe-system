# `PWE_System_Forms_Audit_Notifications_Trait::get_qr_resend_notifications_for_entry()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1461`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_qr_resend_notifications_for_entry($form, $entry)`
