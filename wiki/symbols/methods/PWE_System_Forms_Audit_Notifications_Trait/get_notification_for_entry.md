# `PWE_System_Forms_Audit_Notifications_Trait::get_notification_for_entry()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:616`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_notification_for_entry($form, $entry, $entry_email)`
