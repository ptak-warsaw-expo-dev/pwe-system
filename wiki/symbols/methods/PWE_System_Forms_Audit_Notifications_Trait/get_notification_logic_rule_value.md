# `PWE_System_Forms_Audit_Notifications_Trait::get_notification_logic_rule_value()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1971`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_notification_logic_rule_value($form, $entry, $field_id)`
