# `PWE_System_Forms_Audit_Notifications_Trait::add_admin_notifications_to_unsent_match()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:561`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private add_admin_notifications_to_unsent_match($form, $entry, $match)`
