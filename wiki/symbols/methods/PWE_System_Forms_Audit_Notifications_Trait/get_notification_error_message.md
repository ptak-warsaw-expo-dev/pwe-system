# `PWE_System_Forms_Audit_Notifications_Trait::get_notification_error_message()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:859`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_notification_error_message($entry_id)`
