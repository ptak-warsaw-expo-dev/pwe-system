# `PWE_System_Forms_Audit_Notifications_Trait::notification_contains_qr()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1390`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private notification_contains_qr($notification)`
