# `PWE_System_Forms_Audit_Notifications_Trait::compare_rule_value()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:2093`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private compare_rule_value($actual, $operator, $expected)`
