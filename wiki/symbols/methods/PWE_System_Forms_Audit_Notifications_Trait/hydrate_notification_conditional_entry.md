# `PWE_System_Forms_Audit_Notifications_Trait::hydrate_notification_conditional_entry()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1784`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private hydrate_notification_conditional_entry($form, $entry, $logic)`
