# `PWE_System_Forms_Audit_Notifications_Trait::get_active_notifications_by_language()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:223`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_active_notifications_by_language($form)`
