# `PWE_System_Forms_Audit_Notifications_Trait::ajax_bulk_language_preview()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:9`  
**Typ właściciela:** `trait`  
**Sygnatura:** `public ajax_bulk_language_preview()`
