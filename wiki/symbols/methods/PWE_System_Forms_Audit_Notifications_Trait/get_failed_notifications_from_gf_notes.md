# `PWE_System_Forms_Audit_Notifications_Trait::get_failed_notifications_from_gf_notes()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1008`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_failed_notifications_from_gf_notes($form, $entry_id)`
