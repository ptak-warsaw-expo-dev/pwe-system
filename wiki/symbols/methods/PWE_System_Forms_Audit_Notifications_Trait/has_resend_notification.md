# `PWE_System_Forms_Audit_Notifications_Trait::has_resend_notification()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1301`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private has_resend_notification($form, $entry_id)`
