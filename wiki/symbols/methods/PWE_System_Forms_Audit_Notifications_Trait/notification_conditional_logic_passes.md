# `PWE_System_Forms_Audit_Notifications_Trait::notification_conditional_logic_passes()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1693`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private notification_conditional_logic_passes($notification, $form, $entry)`
