# `PWE_System_Forms_Audit_Notifications_Trait::get_entry_with_language_override()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1312`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_entry_with_language_override($form, $entry, $lang)`
