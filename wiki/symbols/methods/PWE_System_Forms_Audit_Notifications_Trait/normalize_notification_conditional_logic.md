# `PWE_System_Forms_Audit_Notifications_Trait::normalize_notification_conditional_logic()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1751`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private normalize_notification_conditional_logic($logic, $form)`
