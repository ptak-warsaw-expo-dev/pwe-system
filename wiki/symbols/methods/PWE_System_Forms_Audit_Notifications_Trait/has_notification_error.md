# `PWE_System_Forms_Audit_Notifications_Trait::has_notification_error()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:938`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private has_notification_error($entry_id)`
