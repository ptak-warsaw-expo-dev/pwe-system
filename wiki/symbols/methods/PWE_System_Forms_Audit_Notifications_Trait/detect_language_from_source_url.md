# `PWE_System_Forms_Audit_Notifications_Trait::detect_language_from_source_url()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:205`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private detect_language_from_source_url($source_url)`
