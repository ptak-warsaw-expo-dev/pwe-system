# `PWE_System_Forms_Audit_Notifications_Trait::get_entry_named_value()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1908`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_entry_named_value($form, $entry, $names)`
