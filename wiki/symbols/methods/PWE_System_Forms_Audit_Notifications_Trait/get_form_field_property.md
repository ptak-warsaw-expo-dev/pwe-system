# `PWE_System_Forms_Audit_Notifications_Trait::get_form_field_property()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:2025`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_form_field_property($field, $property)`
