# `PWE_System_Forms_Audit_Notifications_Trait::notification_name_is_resend()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1170`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private notification_name_is_resend($name)`
