# `PWE_System_Forms_Audit_Notifications_Trait::replace_notification_variables()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:2080`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private replace_notification_variables($value, $form, $entry)`
