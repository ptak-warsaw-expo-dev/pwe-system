# `PWE_System_Forms_Audit_Notifications_Trait::ajax_resend_notifications()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:260`  
**Typ właściciela:** `trait`  
**Sygnatura:** `public ajax_resend_notifications()`
