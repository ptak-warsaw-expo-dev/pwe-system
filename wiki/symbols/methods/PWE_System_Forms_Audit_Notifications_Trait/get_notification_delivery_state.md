# `PWE_System_Forms_Audit_Notifications_Trait::get_notification_delivery_state()`

**Źródło:** `modules/forms-audit/traits/trait-pwe-forms-audit-notifications.php:1175`  
**Typ właściciela:** `trait`  
**Sygnatura:** `private get_notification_delivery_state($form, $entry_id)`
