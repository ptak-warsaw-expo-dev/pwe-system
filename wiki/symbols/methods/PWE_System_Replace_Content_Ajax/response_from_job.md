# `PWE_System_Replace_Content_Ajax::response_from_job()`

**Źródło:** `modules/replace-content/core/ajax-actions.php:272`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static response_from_job(array $job, string $token)`
