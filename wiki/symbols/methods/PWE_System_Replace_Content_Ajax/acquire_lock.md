# `PWE_System_Replace_Content_Ajax::acquire_lock()`

**Źródło:** `modules/replace-content/core/ajax-actions.php:340`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static acquire_lock(string $token)`
