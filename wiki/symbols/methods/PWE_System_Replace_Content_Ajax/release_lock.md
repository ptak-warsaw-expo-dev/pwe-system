# `PWE_System_Replace_Content_Ajax::release_lock()`

**Źródło:** `modules/replace-content/core/ajax-actions.php:352`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static release_lock(string $token, string $lock_name)`
