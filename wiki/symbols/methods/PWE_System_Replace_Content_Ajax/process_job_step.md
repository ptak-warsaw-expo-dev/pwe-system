# `PWE_System_Replace_Content_Ajax::process_job_step()`

**Źródło:** `modules/replace-content/core/ajax-actions.php:162`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static process_job_step(string $job_key, string $token, array $job, ?int $client_processed, string &$error_message)`
