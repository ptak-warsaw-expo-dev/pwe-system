# `PWE_System_Doc_Manager::error()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:777`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static error(string $message, int $status = 400)`
