# `PWE_System_Doc_Manager::log()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:801`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static log(string $action, ?string $source, ?string $target, array $details = [])`
