# `PWE_System_Doc_Manager::clean_zip_entry()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:702`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static clean_zip_entry(string $name)`
