# `PWE_System_Doc_Manager::zip_entry_is_symlink()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:730`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static zip_entry_is_symlink(ZipArchive $zip, int $index)`
