# `PWE_System_Doc_Manager::handle_upload()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:509`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static handle_upload(bool $force_replace)`
