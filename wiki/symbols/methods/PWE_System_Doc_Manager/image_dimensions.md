# `PWE_System_Doc_Manager::image_dimensions()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:657`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static image_dimensions(string $path, string $extension)`
