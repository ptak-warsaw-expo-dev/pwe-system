# `PWE_System_Doc_Manager::svg_dimension()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:694`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static svg_dimension(string $svg, string $attribute)`
