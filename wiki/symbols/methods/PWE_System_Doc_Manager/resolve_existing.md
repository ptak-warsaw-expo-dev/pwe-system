# `PWE_System_Doc_Manager::resolve_existing()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:609`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static resolve_existing(string $rel, bool $must_be_dir)`
