# `PWE_System_Doc_Manager::is_allowed_filename()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:644`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static is_allowed_filename(string $name)`
