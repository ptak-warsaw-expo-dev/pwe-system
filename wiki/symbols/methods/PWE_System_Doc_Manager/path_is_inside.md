# `PWE_System_Doc_Manager::path_is_inside()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:628`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static path_is_inside(string $path, string $parent, bool $allow_same = false)`

## Kontekst

- Symbol właściciela: [`PWE_System_Doc_Manager`](../../classes/PWE_System_Doc_Manager.md)
- Plik: [dokument pliku](../../../files/modules/doc-manager/class-pwe-system-doc-manager.php.md)
