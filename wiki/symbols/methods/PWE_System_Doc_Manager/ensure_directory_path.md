# `PWE_System_Doc_Manager::ensure_directory_path()`

**Źródło:** `modules/doc-manager/class-pwe-system-doc-manager.php:618`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static ensure_directory_path(string $rel)`
