# `PWE_System_Functions::get_database_premieres_data()`

**Źródło:** `core/class-pwe-system-functions.php:3412`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_premieres_data($fair_domain = null)`
