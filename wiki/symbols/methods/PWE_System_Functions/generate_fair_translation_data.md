# `PWE_System_Functions::generate_fair_translation_data()`

**Źródło:** `core/class-pwe-system-functions.php:4408`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static generate_fair_translation_data($fair)`
