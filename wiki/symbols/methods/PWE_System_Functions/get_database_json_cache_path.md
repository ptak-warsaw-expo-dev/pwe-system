# `PWE_System_Functions::get_database_json_cache_path()`

**Źródło:** `core/class-pwe-system-functions.php:947`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static get_database_json_cache_path($source, $cache_key)`
