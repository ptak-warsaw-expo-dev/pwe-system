# `PWE_System_Functions::get_database_store_packages_data()`

**Źródło:** `core/class-pwe-system-functions.php:2319`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_store_packages_data()`
