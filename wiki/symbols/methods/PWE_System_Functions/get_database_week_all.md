# `PWE_System_Functions::get_database_week_all()`

**Źródło:** `core/class-pwe-system-functions.php:2845`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_week_all($fair_domain = null)`
