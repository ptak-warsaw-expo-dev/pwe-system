# `PWE_System_Functions::get_database_fairs_data_profiles()`

**Źródło:** `core/class-pwe-system-functions.php:3337`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_profiles($fair_domain = null)`
