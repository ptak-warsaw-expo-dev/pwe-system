# `PWE_System_Functions::read_database_json_cache()`

**Źródło:** `core/class-pwe-system-functions.php:1012`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static read_database_json_cache($source, $cache_key)`
