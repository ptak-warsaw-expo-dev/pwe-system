# `PWE_System_Functions::get_database_fairs_data_opinions()`

**Źródło:** `core/class-pwe-system-functions.php:3495`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_opinions($fair_domain = null)`
