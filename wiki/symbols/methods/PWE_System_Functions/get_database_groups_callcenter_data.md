# `PWE_System_Functions::get_database_groups_callcenter_data()`

**Źródło:** `core/class-pwe-system-functions.php:2600`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_groups_callcenter_data()`
