# `PWE_System_Functions::set_translation_context()`

**Źródło:** `core/class-pwe-system-functions.php:43`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static set_translation_context($element_slug, $group, $element_type = 'main')`
