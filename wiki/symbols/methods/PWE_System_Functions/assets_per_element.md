# `PWE_System_Functions::assets_per_element()`

**Źródło:** `core/class-pwe-system-functions.php:157`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static assets_per_element($element_slug, $element_type = 'main', $folder = 'elements')`
