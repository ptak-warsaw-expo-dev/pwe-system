# `PWE_System_Functions::assets_per_group()`

**Źródło:** `core/class-pwe-system-functions.php:190`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static assets_per_group($element_slug, $group, $element_type = 'main', $folder = 'elements', $atts = null)`

## Kontekst

- Symbol właściciela: [`PWE_System_Functions`](../../classes/PWE_System_Functions.md)
- Plik: [dokument pliku](../../../files/core/class-pwe-system-functions.php.md)
