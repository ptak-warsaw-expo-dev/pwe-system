# `PWE_System_Functions::get_database_week_data()`

**Źródło:** `core/class-pwe-system-functions.php:2758`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_week_data($fair_domain = null)`
