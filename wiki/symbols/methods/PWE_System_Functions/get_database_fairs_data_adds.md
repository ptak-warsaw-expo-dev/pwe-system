# `PWE_System_Functions::get_database_fairs_data_adds()`

**Źródło:** `core/class-pwe-system-functions.php:1746`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_adds($fair_domain = null)`
