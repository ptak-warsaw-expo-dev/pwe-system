# `PWE_System_Functions::refresh_database_json_cache()`

**Źródło:** `core/class-pwe-system-functions.php:1104`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static refresh_database_json_cache($domain = null)`
