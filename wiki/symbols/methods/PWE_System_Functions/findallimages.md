# `PWE_System_Functions::findAllImages()`

**Źródło:** `core/class-pwe-system-functions.php:4829`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static findAllImages($firstPath, $image_count = false, $secondPath = '/doc/galeria')`
