# `PWE_System_Functions::get_database_fairs_data_sectors()`

**Źródło:** `core/class-pwe-system-functions.php:3580`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_sectors($fair_domain = null)`
