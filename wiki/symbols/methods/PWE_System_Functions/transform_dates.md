# `PWE_System_Functions::transform_dates()`

**Źródło:** `core/class-pwe-system-functions.php:4548`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static transform_dates($start_date, $end_date, $include_hours = true)`
