# `PWE_System_Functions::get_database_conferences_data()`

**Źródło:** `core/class-pwe-system-functions.php:3139`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_conferences_data($domain = null)`
