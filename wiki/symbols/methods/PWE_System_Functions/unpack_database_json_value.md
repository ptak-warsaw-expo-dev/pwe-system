# `PWE_System_Functions::unpack_database_json_value()`

**Źródło:** `core/class-pwe-system-functions.php:985`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static unpack_database_json_value($value)`
