# `PWE_System_Functions::input_range_field_html()`

**Źródło:** `core/class-pwe-system-functions.php:4898`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static input_range_field_html($settings, $value)`
