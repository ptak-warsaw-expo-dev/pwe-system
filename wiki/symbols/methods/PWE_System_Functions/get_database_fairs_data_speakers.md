# `PWE_System_Functions::get_database_fairs_data_speakers()`

**Źródło:** `core/class-pwe-system-functions.php:3748`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_speakers($fair_domain = null)`
