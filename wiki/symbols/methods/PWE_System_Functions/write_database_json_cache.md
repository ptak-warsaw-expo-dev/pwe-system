# `PWE_System_Functions::write_database_json_cache()`

**Źródło:** `core/class-pwe-system-functions.php:1043`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static write_database_json_cache($source, $cache_key, $data, array $args = [])`
