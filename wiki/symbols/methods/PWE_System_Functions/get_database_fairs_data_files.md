# `PWE_System_Functions::get_database_fairs_data_files()`

**Źródło:** `core/class-pwe-system-functions.php:4011`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_files($fair_domain = null)`
