# `PWE_System_Functions::get_database_elements_order_data()`

**Źródło:** `core/class-pwe-system-functions.php:4191`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_elements_order_data()`
