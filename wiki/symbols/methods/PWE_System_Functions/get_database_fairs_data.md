# `PWE_System_Functions::get_database_fairs_data()`

**Źródło:** `core/class-pwe-system-functions.php:1500`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data($fair_domain = null)`
