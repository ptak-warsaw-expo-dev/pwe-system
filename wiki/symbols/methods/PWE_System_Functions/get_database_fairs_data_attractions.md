# `PWE_System_Functions::get_database_fairs_data_attractions()`

**Źródło:** `core/class-pwe-system-functions.php:3924`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_database_fairs_data_attractions($fair_domain = null)`
