# `PWE_System_Resend_Matcher::notification_is_platyna()`

**Źródło:** `modules/resend/core/notification-matcher.php:28`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static notification_is_platyna(array $notification)`
