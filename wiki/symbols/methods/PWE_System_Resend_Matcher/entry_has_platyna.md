# `PWE_System_Resend_Matcher::entry_has_platyna()`

**Źródło:** `modules/resend/core/notification-matcher.php:23`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static entry_has_platyna(array $form, array $entry)`
