# `PWE_System_Resend_Matcher::get_entry_lang()`

**Źródło:** `modules/resend/core/notification-matcher.php:11`  
**Typ właściciela:** `class`  
**Sygnatura:** `public static get_entry_lang(array $form, array $entry)`
