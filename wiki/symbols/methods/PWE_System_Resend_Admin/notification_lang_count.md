# `PWE_System_Resend_Admin::notification_lang_count()`

**Źródło:** `modules/resend/core/admin-page.php:458`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static notification_lang_count(array $notification_lang_counts, string $group_key, string $lang_key)`
