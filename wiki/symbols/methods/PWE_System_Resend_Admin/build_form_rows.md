# `PWE_System_Resend_Admin::build_form_rows()`

**Źródło:** `modules/resend/core/admin-page.php:90`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static build_form_rows(array $forms, bool $preview_all)`
