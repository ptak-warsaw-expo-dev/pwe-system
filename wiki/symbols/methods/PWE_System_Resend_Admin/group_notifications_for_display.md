# `PWE_System_Resend_Admin::group_notifications_for_display()`

**Źródło:** `modules/resend/core/admin-page.php:389`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static group_notifications_for_display(array $notifications)`
