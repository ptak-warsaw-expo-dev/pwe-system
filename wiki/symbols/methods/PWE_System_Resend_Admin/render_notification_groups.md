# `PWE_System_Resend_Admin::render_notification_groups()`

**Źródło:** `modules/resend/core/admin-page.php:423`  
**Typ właściciela:** `class`  
**Sygnatura:** `private static render_notification_groups(array $groups, array $notification_lang_counts)`
