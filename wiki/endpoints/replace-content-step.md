...
language: pl
---
# `replace-content-step`

- **Typ:** `wp-ajax`
- **Trigger/route:** `admin-ajax.php?action=pwe_replace_content_step`
- **Metody:** `POST`
- **Źródło:** `modules/replace-content/core/ajax-actions.php`
- **Callback:** `PWE_System_Replace_Content_Ajax::step`
- **Hook:** `wp_ajax_pwe_replace_content_step`
